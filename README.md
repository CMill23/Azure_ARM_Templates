...
:shipit: *"Do we have a demo for Azure service **X** / Use Case **Y**"*
...
Tags will help you to to get a first orientation where the links will lead you to <br>
:notebook: - **Repository** 
:books: - **Content** <br>
...
## General Demos & Workshop Content

### Fasttrack for Azure :notebook: 
...
### Microsoft Azure Immersion Workshops :books:
...
- [Cloud Adoption Framework landing zones for Terraform - Application accelerator](https://github.com/dwnatwick/OpenHack/tree/main/byos) | Specific Deployment Guidance for following topics:
